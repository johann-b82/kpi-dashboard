...
**In progress:** v1.11 Outline Wiki + Shared Auth (Dex) — Phase 28 complete (KPI Light OIDC integration: authlib + SessionMiddleware, app_users upsert, all 6 business routers guarded, DISABLE_AUTH dev bypass, frontend useCurrentUser/ProtectedRoute/NavBar logout)
