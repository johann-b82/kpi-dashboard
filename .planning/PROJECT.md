...
**In progress:** v1.11 Outline Wiki + Shared Auth (Dex) — Phase 27 complete (Dex IdP live at https://auth.internal/dex, 2 seeded users, OIDC discovery + login + restart survival verified)
