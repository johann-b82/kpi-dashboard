...
- [x] 47-05-ci-guards-bundle-size-and-uat-PLAN.md — check-player-isolation + bundle-size <200KB + strings parity + signage-invariants extension + 47-VERIFICATION + 47-UAT + human checkpoint (wave 4)
**UI hint**: yes
