...
- [ ] 65-02-PLAN.md — bootstrap-roles.sh section 5 (Viewer per-collection permission rows)
- [ ] 65-03-PLAN.md — Alembic migration: signage_notify() function + 8 triggers
...
| 65. Foundation — Schema + AuthZ + SSE Bridge | v1.22 | 0/5 | Not started | - |
