...
**Plans:** 3 plans
Plans:
- [ ] 13-01-PLAN.md — Models, schemas, migration, PersonioClient extensions, hr_sync.py service
- [ ] 13-02-PLAN.md — APScheduler lifespan, sync router, settings router extensions, main.py wiring
...
| 13. Sync Service & Settings Extension | v1.3 | 0/3 | Not started | - |
