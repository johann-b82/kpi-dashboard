...
- [ ] 68-06-sse-regression-tests-PLAN.md — Extend test_pg_listen_sse.py with Directus-originated schedule lifecycle + tag CRUD silent (Wave 2)
- [ ] 68-07-ci-grep-guard-PLAN.md — CI guard blocking /api/signage/tags + /api/signage/schedules in backend/app/ (Wave 2)
...
| 68. MIG-SIGN — Tags + Schedules | v1.22 | 3/8 | In Progress|  |
