...
**Plans**: 5 plans
  ...
  - [ ] 54-02-navbar-sales-hr-migration-PLAN.md — Migrate NavBar Sales/HR switch to Toggle (TOGGLE-04)
  - [ ] 54-03-chart-type-migrations-PLAN.md — Migrate HrKpiCharts (area/bar) and RevenueChart (bar/area) to Toggle (TOGGLE-04)
  - [ ] 54-04-theme-toggle-migration-PLAN.md — Migrate ThemeToggle to 2-segment Toggle with sun/moon icons (TOGGLE-03; preserve OS + localStorage logic)
  - [ ] 54-05-language-toggle-migration-PLAN.md — Migrate LanguageToggle to 2-segment Toggle with DE/EN labels (TOGGLE-02; preserve i18next switch logic)
**UI hint**: yes
...
| 54. Toggle Primitive + Migrations | v1.19 | 1/5 | In Progress|  |
