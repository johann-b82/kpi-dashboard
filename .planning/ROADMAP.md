...
<details>
<summary>✅ v1.16 Digital Signage (Phases 41–48) — SHIPPED 2026-04-20</summary>
...
<details>
<summary>✅ v1.17 Pi Image Release (Phase 49) — SHIPPED 2026-04-21</summary>
...
<details>
<summary>✅ v1.20 HR Date-Range Filter + TS Cleanup (Phases 60–61) — SHIPPED 2026-04-22</summary>

- [x] Phase 60: HR Date-Range Filter (4/4 plans) — completed 2026-04-22
- [x] Phase 61: TS Cleanup (1/1 plan) — completed 2026-04-22

Full details: [milestones/v1.20-ROADMAP.md](milestones/v1.20-ROADMAP.md)

</details>

<details>
<summary>✅ v1.21 Signage Calibration + Build Hygiene + Reverse Proxy (Phases 62–64) — SHIPPED 2026-04-24</summary>

- [x] Phase 62: Signage Calibration (4/4 plans; CAL-PI-07 hardware walkthrough waived)
- [x] Phase 63: Frontend Build Fix (1/1 plan)
- [x] Phase 64: Reverse Proxy (1/1 plan + 2 post-ship hotfixes)

Full details: [milestones/v1.21-ROADMAP.md](milestones/v1.21-ROADMAP.md) · [audit](milestones/v1.21-MILESTONE-AUDIT.md)
...
- [x] 68-03-backend-schedules-removal-PLAN.md — Delete schedules.py + _fanout_schedule_changed helper + port/delete schedule router tests (Wave 2)
- [x] 68-04-frontend-signageapi-swap-PLAN.md — Inline-swap listTags/createTag/updateTag/deleteTag + listSchedules/createSchedule/updateSchedule/deleteSchedule to Directus SDK (Wave 1)
...
- [x] 69-04-sse-regression-tests-PLAN.md — Extend test_pg_listen_sse.py with Directus playlist + tag-map diff cases + FastAPI DELETE/bulk-PUT regression (Wave 2)
...
- [x] 69-06-admin-permission-smoke-and-test-triage-PLAN.md — Admin Directus CRUD smoke for signage_playlists + signage_playlist_tag_map; rbac + allowlists comment refresh (Wave 2)
**UI hint**: yes
...
**Plans:** 6 plans
Plans:
- [ ] 70-01-backend-resolved-router-PLAN.md — NEW FastAPI GET /api/signage/resolved/{device_id} + register in signage_admin package (Wave 1)
- [ ] 70-02-backend-devices-router-trim-PLAN.md — Trim devices.py to calibration PATCH + retained _notify_device_self helper (Wave 1)
- [ ] 70-03-frontend-signageapi-swap-PLAN.md — Swap listDevices/getDevice/updateDevice/replaceDeviceTags + add getResolvedForDevice/deleteDevice; revokeDevice unchanged (Wave 1)
...
- [ ] 70-05-sse-tests-and-triage-PLAN.md — SSE regression for device + tag-map + calibration no-double-fire; admin smoke; RBAC + allowlists triage (Wave 2)
- [ ] 70-06-ci-grep-guard-PLAN.md — Method-anchored CI guard scoped to devices.py blocking migrated routes; allow calibration PATCH (Wave 2)
**UI hint**: yes
...
| 70. MIG-SIGN — Devices | v1.22 | 0/6 | Planned | - |
